...
<script src="${pageContext.request.contextPath}/subgroup/calendar/js/jscal2.js"></script>
<script src="${pageContext.request.contextPath}/subgroup/calendar/js/en.js"></script>
<script src="${pageContext.request.contextPath}/js/manager/emr/doctor.common.js"></script>
...
//var fz='${param.fz}';
var fucha='${param.fucha}';
var sfzh=null;
var fenzhenkaidan='${param.fenzhenkaidan}';
</script>
...
<script src="js/emr_functions.js"></script>
<script src="js/huanZheFenZhen.js"></script>
<script src="js/emr_quGuang.js"></script>
<script src="${pageContext.request.contextPath}/jmsxj/js/entry.js"></script>
<style type="text/css">
...
<body>
	...
	<div id="visitRecord">
		...
		<a id="hospitalRecord" class="hiden_a"><label class="hiden_a_label">住院病历<span style="color:blue; display:block"> 5 </span>次</label></a>
		<a id="oldVisitRecord" class="hiden_a"><label class="hiden_a_label">原系统既往病历<span style="color:blue; display:block"> 5 </span>次</label></a>
	</div>
