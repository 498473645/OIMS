...
function doctorSearchHeandler(){
	...
	search.length?$.extend(list_set.data,{search:search}):$.extend(list_set.data,{startTime:getDateNow()});
	try{
...
function findBingliEx(){
	...
	$("input#zcrqStart").val(getDateNow());
	...
	var rt = "<table width='100%' cellspacing='0' cellpadding='0' border='0'>" +
				" <tr>" +
                 ...
                 " <tr>" +
 				  ...
 				  "<td  nowrap='nowrap' align='right' ><font color='red'>'+'代表并且,'/'代表或者</font></td>"
 					 +
                 "</tr>" +
		        "<tr>" +
