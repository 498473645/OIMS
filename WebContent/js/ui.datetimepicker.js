...
Timepicker.prototype = {
    ...
    _generateHtml: function ()
    {
		...
		html += 'table.ui-timepicker a {font-size:14px;text-align:center}';
		...
		html += '<tr><th>小时</th><td><a href="#">08</a></td><td><a href="#">09</a></td><td><a href="#">10</a></td><td><a href="#">11</a></td><td><a href="#">13</a></td><td><a href="#">14</a></td><td><a href="#">15</a></td><td><a href="#">16</a></td><td><a href="#">17</a></td><td></td><td></td><td></td></tr>';
		html += '<tr><th>分钟</th><td><a href="#">00</a></td><td><a href="#">10</a></td></td><td><a href="#">20</a></td><td><a href="#">30</a></td><td><a href="#">40</a></td><td><a href="#">50</a></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>';
		html += '<tr><th>&nbsp;</th><td colspan="12"><div id="minuteSlider" class="slider"></div></td></tr>';
	//	html += '<tr><th>&nbsp;</th><td colspan="2"><a id="ui-timepicker-am" href="#" type="hour">上午</a></td><td colspan="2"><a id="ui-timepicker-pm" href="#" type="hour">下午</a></td></tr>';
        html += '</tbody></table>';
		html += '<div style="width:97%;position:absolute;left:1%;bottom:0" class="ui-datepicker-buttonpane ui-widget-content">';
		html += '<button class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="$.datepicker._hideDatepicker();" type="button">确定</button>';
		html += '</div>';
...
//		});		
    ...
    _writeTime: function (type, value)
    {
        ...
        if (type == 'minute') {
            if (value < 10) value = '0' + value;
            $("#" + this._mainDivId + ' span.fragMinutes').text(value+":00");
        }
    },
