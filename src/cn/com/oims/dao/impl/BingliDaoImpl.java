...
public class BingliDaoImpl extends BaseDaoEx implements IBingliDao {
  ...
  public List<Map<String, Object>> findBySeach(BingliForm bl, Page p) {
    ...
    String hql = "select new map(h.id as id ,h.shouji as shouji, h.binglihao as binglihao,h.xingming as xingming , h.xingbie as xingbie, h.shengri as shengri ,h.jtdz as jtdz, y.xingming as doctor, (select count(*) from Jiuzhen chj where chj.huanzheId=h.id ) as cs )";
