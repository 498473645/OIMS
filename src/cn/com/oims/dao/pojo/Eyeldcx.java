...
@Entity
@Table(name = "Eyeldcx")
public class Eyeldcx implements Serializable {
  ...
  @Id
  @Column(name = "flow_no")
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "eyeldcx_sequence")
  @SequenceGenerator(name = "eyeldcx_sequence", allocationSize = 1, initialValue = 1, sequenceName = "eyeldcx_sequence")
