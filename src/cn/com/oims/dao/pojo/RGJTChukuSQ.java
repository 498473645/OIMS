...
@Entity
@Table(name = "rgjt_chukusq")
public class RGJTChukuSQ implements Serializable {
  private static final long serialVersionUID = -8803700677729258390L;
  
  @Id
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "rgjt_chukusq_sequence")
  @SequenceGenerator(name = "rgjt_chukusq_sequence", allocationSize = 1, initialValue = 1, sequenceName = "rgjt_chukusq_sequence")
  private Long id;
