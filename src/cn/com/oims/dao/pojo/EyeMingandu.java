...
@Entity
@Table(name = "Eyemingandu")
public class EyeMingandu implements Serializable {
  private static final long serialVersionUID = 7077399092074257536L;
  ...
  @Id
  @Column(name = "flow_no")
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "eyemingandu_sequence")
  @SequenceGenerator(name = "eyemingandu_sequence", allocationSize = 1, initialValue = 1, sequenceName = "eyemingandu_sequence")
