...
@Entity
@Table(name = "Eyeygzy")
public class Eyeygzy implements Serializable {
  private static final long serialVersionUID = 4670693072738323861L;
  ...
  private String ygzy_result;
  
  private String check_doc;
  
  private String yanbie;
  
  private String ygzy_no;
  
  private String ygzy_method;
  ...
  @Id
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "eyeygzy_sequence")
  @SequenceGenerator(name = "eyeygzy_sequence", allocationSize = 1, initialValue = 1, sequenceName = "eyeygzy_sequence")
  @Column(name = "flow_no")
  ...
  public String getYgzy_result() {
    return this.ygzy_result;
  }
  
  public void setYgzy_result(String ygzy_result) {
    this.ygzy_result = ygzy_result;
  }
  ...
  public String getYgzy_no() {
    return this.ygzy_no;
  }
  
  public void setYgzy_no(String ygzy_no) {
    this.ygzy_no = ygzy_no;
  }
  
  public String getYgzy_method() {
    return this.ygzy_method;
  }
  
  public void setYgzy_method(String ygzy_method) {
    this.ygzy_method = ygzy_method;
  }
