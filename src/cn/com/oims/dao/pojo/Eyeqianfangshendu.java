...
@Entity
@Table(name = "Eyeqianfangshendu")
public class Eyeqianfangshendu implements Serializable {
  ...
  @Id
  @Column(name = "flow_no")
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "eyeqianfangshendu_sequence")
  @SequenceGenerator(name = "eyeqianfangshendu_sequence", allocationSize = 1, initialValue = 1, sequenceName = "eyeqianfangshendu_sequence")
