...
//						"<option>15800</option>" +
				...
				"</td>" +
				"<td align='center' class='td_border' colspan='4' align='center'>" +
					"<input type='checkbox' id='yyxm6' name='yyxm'/>&nbsp;&nbsp;Smart-TPRK&nbsp;&nbsp;&nbsp;&nbsp;手术费用：&nbsp;&nbsp;"+
		...
		area+="</td>" +
			...
			"</tr>" +
				...
				"<table id='ssjlAdd' cellpadding='5' cellspacing='0' width='100%' >" +
					...
					"<tr><td style='font-size:16px;font-weight:bold;'><label style='font-weight:bolder;'>联系电话：</label>(023)68766263&nbsp;&nbsp;&nbsp;&nbsp;68766266</td></tr>" +
