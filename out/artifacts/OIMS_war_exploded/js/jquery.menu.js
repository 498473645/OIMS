    ...
    $.fn.menu = function(setting) {
        ...
        function createMenu(data,target,type) {
            ...
            $.each(data, function(i,d) {
                ...
                var a = $("<a style='text-overflow: ellipsis;o-text-overflow: ellipsis;overflow: hidden;white-space: nowrap;width:173px;'></a>").appendTo(li);
                if(type==1){
                	//子目录不加图标
                }else{
               ...
               //  }
                ...
                if(d.child!=undefined && d.child.length>0){
                    createMenu(d.child,ul,1);//新增type 1表示子目录
                }
            });
