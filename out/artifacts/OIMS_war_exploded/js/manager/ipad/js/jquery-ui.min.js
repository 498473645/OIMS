(function(a, d) {
	...
	a.ui.ddmanager = {
		...
		dragStart: function(d, c) {
			d.element.parents(":not(body,html)").bind("scroll.droppable",
			function() {
	...
	a.widget("ui.resizable", a.ui.mouse, {
		...
		_create: function() {
			...
			if (this.element[0].nodeName.match(/canvas|textarea|input|select|button|img/i)) { / relative / .test(this.element.css("position")) && a.browser.opera && this.element.css({
					position: "relative",
					top: "auto",
					left: "auto"
				});
		...
		_proportionallyResize: function() {
			if (this._proportionallyResizeElements.length) for (var e = this.helper || this.element,
			h = 0; h < this._proportionallyResizeElements.length; h++) {
	...
	a.ui.plugin.add("resizable", "alsoResize", {
		...
		stop: function() {
			...
			if (e._revertToRelativePosition) {
				...
				typeof h.alsoResize == "object" && !h.alsoResize.nodeType ? a.each(h.alsoResize,
				function(i) {
					g(i)
				}) : g(h.alsoResize)
			}
			...
			if (!this.options.disabled) {
				...
				a(d.target).parents().andSelf().each(function() {
					...
					if (h) {
						...
						h.unselecting = !g;
						h.selecting = g; (h.selected = g) ? c._trigger("selecting", d, {
							selecting: h.element
						}) : c._trigger("unselecting", d, {
							unselecting: h.element
						});
	...
	a.widget("ui.sortable", a.ui.mouse, {
		...
		_contactContainers: function(d) {
			for (var c = null,
			e = null,
			h = this.containers.length - 1; h >= 0; h--) if (!a.ui.contains(this.currentItem[0], this.containers[h].element[0])) if (this._intersectsWith(this.containers[h].containerCache)) {
...
function(a, d) {
	...
	a.effects.blind = function(d) {
		return this.queue(function() {
			...
			var f = {};
			f[b] = h == "show" ? g: 0;
			i.animate(f, d.duration, d.options.easing,
			function() {
				h == "hide" && c.hide();
	...
	a.effects.fold = function(d) {
		return this.queue(function() {
			...
			i[l[0]] = h == "show" ? j[0] : g;
			o[l[1]] = h == "show" ? j[1] : 0;
			f.animate(i, b, d.options.easing).animate(o, b, d.options.easing,
			function() {
				h == "hide" && c.hide();
				a.effects.restore(c, e);
				a.effects.removeWrapper(c);
	...
	a.effects.shake = function(d) {
		return this.queue(function() {
			...
			c.animate(l, b, d.options.easing).animate(h, b / 2, d.options.easing,
			function() {
				a.effects.restore(c, e);
				a.effects.removeWrapper(c);
				d.callback && d.callback.apply(this, arguments)
	...
	a.effects.transfer = function(d) {
		return this.queue(function() {
			...
			var g = a('<div class="ui-effects-transfer"></div>').appendTo(document.body).addClass(d.options.className).css({
				...
				width: c.innerWidth(),
				position: "absolute"
			}).animate(e, d.duration, d.options.easing,
			function() {
				g.remove();
				d.callback && d.callback.apply(c[0], arguments);
				c.dequeue()
	...
	a.widget("ui.accordion", {
		...
		_create: function() {
			...
			d.headers = d.element.find(c.header).addClass("ui-accordion-header ui-helper-reset ui-state-default ui-corner-all").bind("mouseenter.accordion",
			function() {
			...
			c.event && d.headers.bind(c.event.split(" ").join(".accordion ") + ".accordion",
			function(g) {
	...
	a.extend(c.prototype, {
			...
			if (this._get(b, "autoSize") && !b.inline) {
				...
				if (j.match(/[DM]/)) {
					var l = function(o) {
						for (var n = 0,
						k = 0,
						m = 0; m < o.length; m++) if (o[m].length > n) {
							n = o[m].length;
							k = m
						}
						return k
		...
		_possibleChars: function(b) {
			for (var f = "",
			j = false,
			l = function(n) { (n = o + 1 < b.length && b.charAt(o + 1) == n) && o++;
				return n
			},
		...
		_determineDate: function(b, f, j) {
			...
			o = function(n) {
				...
				q = m.getMonth();
				m = m.getDate();
				for (var s = /([+-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g,
				r = s.exec(n); r;) {
					switch (r[2] || "d") {
					case "d":
					case "D":
	...
	a.widget("ui.dialog", {
		...
		_create: function() {
			...
			function() {
				...
				g.close(n);
				return false
			}).appendTo(l); (g.uiDialogTitlebarCloseText = a("<span></span>")).addClass("ui-icon ui-icon-closethick").text(i.closeText).appendTo(o);
		...
		close: function(g) {
			...
			if (false !== i._trigger("beforeClose", g)) {
				...
				i._isOpen = false;
				if (i.options.hide) i.uiDialog.hide(i.options.hide,
				function() {
					i._trigger("close", g)
				});
				else {
		...
		open: function() {
			if (!this._isOpen) {
				...
				b.show(i.show);
				g.moveToTop(true);
				i.modal && b.bind("keypress.ui-dialog",
				function(f) {
		...
		_position: function(g) {
			...
			} else g = a.ui.dialog.prototype.options.position; (f = this.uiDialog.is(":visible")) || this.uiDialog.show();
			this.uiDialog.css({
				top: 0,
				left: 0
			}).position(a.extend({
		...
		_setOption: function(g, i) {
			...
			case "draggable":
				...
				j && !i && f.draggable("destroy"); ! j && i && b._makeDraggable();
				break;
			case "position":
				b._position(i);
				break;
			case "resizable":
				...
				j && typeof i === "string" && f.resizable("option", "handles", i); ! j && i !== false && b._makeResizable(i);
				break;
			case "title":
	...
	a.extend(a.ui.dialog.overlay, {
		...
		create: function(g) {
			if (this.instances.length === 0) {
				...
				1);
				a(document).bind("keydown.dialog-overlay",
				function(b) {
	...
	a.widget("ui.tabs", {
		...
		_tabify: function(i) {
			...
			if (i) {
				...
				j.disabled = a.unique(j.disabled.concat(a.map(this.lis.filter(".ui-state-disabled"),
				function(r) {
			...
			this.anchors.bind(j.event + ".tabs",
			function() {
				var r = this,
				u = a(r).closest("li"),
		...
		remove: function(i) {
			...
			b.disabled = a.map(a.grep(b.disabled,
			function(l) {
				return l != i
			}),
			function(l) {
