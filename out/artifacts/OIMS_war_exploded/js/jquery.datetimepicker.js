...
//									datetimepicker.data('xdsoft_datetime').setCurrentTime($(this).val());
				...
				timebox
					.on('click.xdsoft','div',function() {
						...
						if( $this.hasClass('xdsoft_disabled') )
							return false;
						if((options.maxDate&&currentTime.getTime()>Date.parseDate(options.maxDate,options.formatDate).getTime())||(options.minDate&&currentTime.getTime()<Date.parseDate(options.minDate,options.formatDate).getTime()))return false;
