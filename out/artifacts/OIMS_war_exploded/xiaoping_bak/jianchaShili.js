...
function initBtnFooter(){
	...
	$("<a href='javascript:saveVision();'><span class='save'></span>保存</a>").appendTo("#footer");
...
function showJcdForm(){
	...
	$("<div/>").addClass("title1").text("视力检查").appendTo(".left");
	...
	var shilitab = "<form id='shiliFm'><table width='100%' border='0' cellSpacing='0' cellPadding='0'>" +
	               "<tr><th></th><th>裸眼视力</th><th>矫正视力</th><th>近视力</th></tr>"+
	               "<tr><td class='seet' nowrap='nowrap'>左眼</td>" +
	                   ...
	                   "</td></tr>"+
	               "<tr><td class='seet' nowrap='nowrap'>右眼</td>" +
